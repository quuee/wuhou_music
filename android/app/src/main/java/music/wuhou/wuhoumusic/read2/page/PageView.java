...
import music.wuhou.wuhoumusic.read2.animation.HorizonPageAnim;
import music.wuhou.wuhoumusic.read2.animation.PageAnimation;
import music.wuhou.wuhoumusic.read2.animation.SimulationPageAnim;
...
//        }
     ...
     * @return
     */
    public PageLoader getPageLoader(BookBean book) {
        // 判是否已经存在
        if (mPageLoader != null) {
            return mPageLoader;
        }
        // 根据书籍类型，获取具体的加载器
//        if (book.isLocal()) {
//            mPageLoader = new LocalPageLoader(this, book);
//        } else {
