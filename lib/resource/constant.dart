...
//   // 歌单
//   {'name': 'songsList', 'limit': false},
//   // 歌
//   {'name': 'songs', 'limit': false},
//   // 缓存播放队列
...
class Keys {
  ...
  // static final String hiveSongsList = 'songsList'; // 相当于数据库或者表
  static final String localSongsList = 'localSongsList'; // key

  // static final String hiveSongs = 'songs';
