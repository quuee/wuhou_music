...
//   }
//
//   /// 用于判断是否需要重新绘制。注意这里的oldDelegate是前一帧的自己，当当前的自己与之前的自己有不一样的地方时需要重新绘制
//   @override
...
//     }
//
//     if (readController.animation == 'curl' && image == null && toImageIng != true) {
//       toImageIng = true;
...
//       if (readController.animation.startsWith("simulation2")) {
//         // 中间阴影
...
//       return;
//     } else {
//       switch (readController.animation) {
//         case 'curl':
//           if (image == null) {
...
//             toImage(picture, size);
//           } else {
//             paintCurl(canvas, size, pos, image!, Color(0xFFFFFFCC),
//                 readController.backgroundImage);
//           }
//           break;
//
//         case 'cover':
...
//                 () {
//               final nextPicture = readController.getPicture(index + 1, size);
